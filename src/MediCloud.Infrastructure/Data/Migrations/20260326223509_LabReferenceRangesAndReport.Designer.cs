...
namespace MediCloud.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260326223509_LabReferenceRangesAndReport")]
    partial class LabReferenceRangesAndReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Appointment", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Bill", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.BillItem", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Consultation", b =>
                {
                    b.Property<Guid>("ConsultationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabObservation", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabOrder", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabOrderItem", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabResult", b =>
                {
                    b.Property<Guid>("LabResultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabTestCatalog", b =>
                {
                    b.Property<Guid>("LabTestCatalogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Patient", b =>
                {
                    b.Property<Guid>("PatientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.PatientAllergy", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.PatientDocument", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Payment", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Prescription", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.PrescriptionItem", b =>
                {
                    b.Property<Guid>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Tenant", b =>
                {
                    b.Property<Guid>("TenantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.User", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Appointment", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MediCloud.Core.Entities.Patient", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Bill", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.BillItem", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.Bill", "Bill")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Consultation", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.Appointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabObservation", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.LabResult", "LabResult")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabOrder", b =>
                {
                    ...
                    b.HasOne("MediCloud.Core.Entities.Consultation", "Consultation")
                        .WithMany()
                        .HasForeignKey("ConsultationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MediCloud.Core.Entities.User", "OrderingDoctor")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabOrderItem", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.LabOrder", "LabOrder")
                        .WithMany("Items")
                        .HasForeignKey("LabOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MediCloud.Core.Entities.LabTestCatalog", "LabTestCatalog")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.LabResult", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.LabOrderItem", "LabOrderItem")
                        .WithOne("LabResult")
                        .HasForeignKey("MediCloud.Core.Entities.LabResult", "LabOrderItemId")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.PatientDocument", b =>
                {
                    ...
                    b.HasOne("MediCloud.Core.Entities.User", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("MediCloud.Core.Entities.User", "ReceivedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.Prescription", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.User", "DispensedBy")
                        .WithMany()
                    ...
                    b.HasOne("MediCloud.Core.Entities.User", "PrescribedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.PrescriptionItem", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.Prescription", "Prescription")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MediCloud.Core.Entities.User", b =>
                {
                    b.HasOne("MediCloud.Core.Entities.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MediCloud.Core.Entities.Tenant", "Tenant")
                        .WithMany()
