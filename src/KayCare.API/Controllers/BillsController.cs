...
public class BillsController : ControllerBase
{
    ...
    private readonly IBillingPdfService _report;

    public BillsController(IBillingService billing, IBillingPdfService report)
    {
        _billing = billing;
        _report  = report;
    }
    ...
    [HttpGet("outstanding")]
    [Authorize(Roles = $"{Roles.Admin},{Roles.SuperAdmin},{Roles.Receptionist},{Roles.BillingOfficer}")]
