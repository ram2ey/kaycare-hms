...
resource sqlDb 'Microsoft.Sql/servers/databases@2023-05-01-preview' = {
  ...
  properties: {
    ...
    useFreeLimit:                true          // use the free monthly grant
    freeLimitExhaustionBehavior: 'AutoPause'  // pause instead of billing when exhausted
  }
}
...
resource apiApp 'Microsoft.Web/sites@2023-01-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      alwaysOn:        false    // not supported on F1 Free
      ftpsState:       'Disabled'
      minTlsVersion:   '1.2'
      appSettings: [
        {
